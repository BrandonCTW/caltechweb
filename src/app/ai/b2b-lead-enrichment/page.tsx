...
export const metadata: Metadata = {
  title: "B2B Lead Enrichment Services | Custom AI Automation | CalTech Web",
  description: "We build custom B2B lead enrichment pipelines that process high-volume inbound email, deduplicate against your contact database, enrich every sender with domain metrics and contact data, score leads, and deliver a ranked digest daily.",
};
...
export default function B2BLeadEnrichmentPage() {
  return (
    <>
      <Header />
      <main>
        ...
        <section className="bg-gradient-to-br from-gray-950 via-blue-950 to-gray-900 text-white py-20 sm:py-28 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <nav className="flex items-center gap-1.5 text-xs text-blue-400/70 mb-6 flex-wrap">
              ...
              <ChevronRight className="w-3 h-3" />
              <span className="text-blue-400">B2B Lead Enrichment</span>
            </nav>
