...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Wix, Squarespace, and GoDaddy look affordable, until you add up your time, add-ons, and missed conversions. Here is the honest cost comparison.",
    excerpt:
    ...
    sections: [
      {
        ...
        list: [
          "Wix: $17–$36/month for business plans. Add an ecommerce feature, a contact form that doesn't look like default Wix, a scheduling tool, and you're easily at $60–$80/month before you've even customized the design.",
      ...
      },
      {
        ...
        body: [
          ...
          "If that's not you, if you just need a website that works and gets out of your way, then $99/month is the better investment.",
        ],
      },
    ],
    conclusion:
  ...
  },
  {
    ...
    excerpt:
      "Your church website is often the first thing a visitor sees before they ever walk through your doors. Here is what it needs to say and do to turn visitors into members.",
    readTime: "5 min read",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Keep it current. A calendar with events from 2024 does more harm than good because it makes the site look abandoned. Even if you have one recurring event, keep the dates updated.",
        ],
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      "Your website is live, so who keeps it updated? Learn your options for ongoing website updates and why CalTech Web includes unlimited updates for $99/mo.",
    excerpt:
      "The website launches and the designer disappears. Now what? Here is who actually keeps your site updated, and the option most business owners don't know about.",
    readTime: "5 min read",
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Years in business and number of completed projects, because experience is reassuring",
          "Professional photos of your team and trucks, because people want to see who's coming to their house",
  ...
  },
  {
    ...
    date: "January 5, 2026",
    intro:
      "Every week, your pastor delivers a message that could impact someone's life. But right now, that message reaches only the people who were physically present on Sunday morning. Everyone else (the members who were traveling, the visitors who aren't ready to walk through the door yet, the person searching for hope at 2am on a Tuesday) misses it entirely.\n\nPosting sermons online changes that equation. It extends your ministry beyond the building, beyond Sunday, and beyond your immediate community. And it's not nearly as complicated as most churches think.\n\nHere's a complete guide to getting your sermons online, organized, and discoverable.",
    sections: [
      {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Testimonials from current volunteers about their experience, because social proof works in ministry too",
        ],
      },
      {
