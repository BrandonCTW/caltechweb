  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-600 px-5 py-4 flex items-center gap-3">
        <Image src="/brandon-hopkins.jpg" alt="Brandon Hopkins" width={72} height={72} sizes="36px" className="w-9 h-9 rounded-full object-cover border-2 border-white/30 shrink-0" />
        <div>
      ...
      <div className="px-5 py-5 space-y-4 bg-gray-50 min-h-[220px]">
        {messages.slice(0, visibleCount).map((msg, i) =>
          msg.from === "client" ? (
            ...
            >
              <Image src="/brandon-hopkins.jpg" alt="Brandon Hopkins" width={72} height={72} sizes="36px" className="w-7 h-7 rounded-full object-cover shrink-0 mb-0.5" />
